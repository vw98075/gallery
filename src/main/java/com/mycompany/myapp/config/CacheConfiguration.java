...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Photo.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Photo.class.getName() + ".tags", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Tag.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Tag.class.getName() + ".photos", jcacheConfiguration);
